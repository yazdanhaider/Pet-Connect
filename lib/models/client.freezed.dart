...
class _$ClientImpl implements _Client {
  const _$ClientImpl(
      ...
      required final List<String> petNames,
      this.notes})
      : _petNames = petNames;
  ...
  @override
  String toString() {
    return 'Client(id: $id, name: $name, email: $email, phone: $phone, address: $address, petNames: $petNames, notes: $notes)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, email, phone, address,
      const DeepCollectionEquality().hash(_petNames), notes);
